...
class _UpdateTrackPopupState extends State<UpdateTrackPopup> {
  ...
  void initState() {
    ...
    if (widget.second == 0 || widget.second > 5)
      rating = 3;
          ...
          RatingBar.builder(
            ...
            onRatingUpdate: (rating){
              setState(() {
                ...
                UserSecurity = userSecurityStates[rating.toInt().toString()].toString();
              });
            },
          ),
        ],
            ...
            children: [
              ...
              TextButton(
                onPressed: (){
                  getToken().then((x) => widget.client.delete(
                      deleteTrackUrl(widget.trackid), headers: {HttpHeaders.authorizationHeader: x}));
              ...
              onPressed: () {
                ...
                getToken().then((x){
                  ...
                  final Map<String, String> headers = {"Content-Type" : "application/json", HttpHeaders.authorizationHeader: x};
                  final String task = widget.taskid.toString();
                  final String rating_0 = dropOptions.keys.firstWhere((x) => dropOptions[x] == dropdownValueOne);
